...
template size_t IterableObjectHasher<TextType>::operator()(const IterableObject<TextType> &k) const;
...
template size_t IterableObjectHasher<TextType1>::operator()(const IterableObject<TextType1> &k) const;
